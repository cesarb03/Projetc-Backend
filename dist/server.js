...
//RUTAS
app.use('/login', routes_1.sessionLogin);
app.use('/logout', routes_1.sessionLogout);
app.use('/signup', routes_1.sessionSignup);
app.use('/api', routes_1.productsRouter, routes_1.cartRouter);
app.get('/', auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, productsControllers_1.getAll)(req, res)];
            case 1:
                products = _a.sent();
...
app.use('/info', routes_1.info);
app.use('/infoCompressed', (0, compression_1.default)(), routes_1.info);
